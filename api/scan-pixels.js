...
module.exports = async function handler(req, res) {
  ...
  const PIXEL_SIGNATURES = [
    ...
    { name: 'TikTok Ads', patterns: ['analytics.tiktok.com', 'ttq.load'] },
    { name: 'Snap Pixel', patterns: ['sc-static.net/scevent.min.js', 'snaptr('] },
    { name: 'Pinterest Ads', patterns: ['s.pinimg.com/ct/core.js', 'pintrk('] },
    { name: 'Twitter Ads', patterns: ['static.ads-twitter.com', 'twq('] },
    { name: 'LinkedIn Ads', patterns: ['snap.licdn.com/li.lms-analytics', '_linkedin_partner_id'] },
